...
import tracingImage from "figma:asset/7a98563ac87ea0de733f1b8a7ee0b22ccbd9a5e5.png";
...
import musicPerformanceImage from "figma:asset/a16a1253af0f83d150b2748d0a7f628056de5531.png";
import guitarPedalsImage from "figma:asset/927a5d5eab3d140778c68bf50d4f51472ee10f29.png";
...
export default function App() {
  ...
  // Set purple favicon on mount
  useEffect(() => {
    // Create a simple SVG favicon with a gradient purple color
    const svg = `
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100">
        <defs>
          <linearGradient id="purpleGradient" x1="0%" y1="0%" x2="100%" y2="100%">
            <stop offset="0%" style="stop-color:#f0a8ef;stop-opacity:1" />
            <stop offset="100%" style="stop-color:#e67ce4;stop-opacity:1" />
          </linearGradient>
        </defs>
        <rect width="100" height="100" fill="url(#purpleGradient)"/>
        <text x="50" y="70" font-size="60" text-anchor="middle" fill="#ffffff" font-family="Arial, sans-serif" font-weight="bold">R</text>
      </svg>
    `;
      ...
      >
        <div className="max-w-[1800px] mx-auto px-4 sm:px-8 md:px-16 py-4 sm:py-6 flex justify-between items-center">
          ...
          <div className="flex gap-3 items-center">
            ...
            <motion.a 
              whileHover={{ opacity: 0.5, borderColor: 'hsl(301, 68%, 69%)', color: 'hsl(301, 68%, 69%)' }}
              href="https://dribbble.com/roxannemustafa" 
              target="_blank"
              rel="noopener noreferrer"
              className="w-9 h-9 rounded-full border-2 border-foreground flex items-center justify-center transition-all duration-100"
              aria-label="Dribbble"
        ...
        {!selectedProject && !showResume && !showProcessPage && !showWhatShapesMe && (
          <AnimatePresence>
            <motion.section 
              ...
              className="min-h-[calc(100vh-88px)] flex flex-col relative"
            >
              ...
              <motion.div
                ...
                className="py-4 sm:py-6 px-4 sm:px-8 md:px-16 sticky top-[88px] bg-background/95 backdrop-blur-sm border-t border-border/40 shadow-sm z-50 overflow-x-auto hidden md:block"
                style={{ fontFamily: 'var(--font-lato)' }}
              >
