...
export function ContactForm({ isOpen, onClose }: ContactFormProps) {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const subject = encodeURIComponent("Re: Let's Connect");
    const body = encodeURIComponent(
      `Date: ${currentDate}\n\nFrom: ${userEmail}\n\n${message}`
    );
    
    window.location.href = `mailto:roxannemustafa@gmail.com?subject=${subject}&body=${body}`;
            ...
            <form onSubmit={handleSubmit} className="px-8 py-8">
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 bg-background border border-border text-foreground focus:border-[#e67ce4] focus:outline-none transition-colors duration-200"
                    style={{
                      fontFamily: '"EB Garamond", Georgia, serif',
                      fontSize: '16px'
                    }}
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full px-4 py-3 bg-background border border-border text-foreground focus:border-[#e67ce4] focus:outline-none transition-colors duration-200 resize-vertical"
                    style={{
                      fontFamily: '"EB Garamond", Georgia, serif',
                      fontSize: '16px',
                      lineHeight: '1.6'
              ...
              <div className="flex gap-4 justify-end mt-8 pt-6 border-t border-border">
                ...
                <motion.button
                  ...
                  whileHover={{ scale: 1.02 }}
                  whileTap={{ scale: 0.98 }}
                  className="px-8 py-3 bg-[#e67ce4] text-white hover:bg-[#d66bd3] transition-colors duration-200 flex items-center gap-2"
                  style={{
                    fontFamily: 'var(--font-lato)',
                    fontSize: '14px',
                    fontWeight: 700,
